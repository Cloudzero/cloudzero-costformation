...
Issues should be used to report problems with the library, request a new feature, or to discuss potential changes before a PR is created. When you create a new Issue, please describe the problem clearly and include enough information (steps to reproduce, expected vs. actual behavior, versions) for us to investigate.
...
Please install the pre-commit hooks before contributing. They run secret
detection ([gitleaks](https://github.com/gitleaks/gitleaks)) and lint/format
([ruff](https://github.com/astral-sh/ruff)) locally so problems are caught
...
When bumping hook versions, use `uvx pre-commit autoupdate --freeze` so the
pinned revisions stay immutable commit SHAs rather than mutable tags.

The same secret and dependency-license scans run in CI (`Security Scan`) and
block merges on findings.

## Licensing of Contributions

By submitting a pull request, you represent that you have the right to license
your contribution to CloudZero, Inc. and the community, and you agree that your
